...
<head>
    ...
    <meta name="description" content="MicroHack - Plataforma de práctica de hacking ético. Inicia sesión para acceder a tus workspaces vulnerables.">
    <meta name="keywords" content="hacking ético, pentesting, seguridad informática, práctica, vulnerabilidades">
    <meta name="author" content="Soblend Development Studio">
    
    <!-- Open Graph / Facebook -->
    <meta property="og:type" content="website">
    <meta property="og:url" content="https://microhack.wuaze.com/login.php">
    <meta property="og:title" content="Iniciar Sesión - MicroHack">
    <meta property="og:description" content="Plataforma de práctica de hacking ético - Inicia sesión para acceder">
    ...
    <meta property="twitter:url" content="https://microhack.wuaze.com/login.php">
    <meta property="twitter:title" content="Iniciar Sesión - MicroHack">
    <meta property="twitter:description" content="Plataforma de práctica de hacking ético - Inicia sesión para acceder">
    <meta property="twitter:image" content="https://rogddqelmxyuvhpjvxbf.supabase.co/storage/v1/object/public/files/j26axlgbc2f.png">
    
    <title>Iniciar Sesión - MicroHack</title>
    ...
    <div class="auth-container">
        ...
        <div class="auth-card">
            <div class="auth-header">
                ...
                <p class="auth-description">Ingresa tus credenciales para acceder</p>
            </div>
    ...
    <script>
        ...
        function togglePassword() {
            ...
            if (passwordInput.type === 'password') {
                ...
                eyeIcon.outerHTML = '<i data-lucide="eye-off" id="eye-icon"></i>';
            } else {
                passwordInput.type = 'password';
                eyeIcon.outerHTML = '<i data-lucide="eye" id="eye-icon"></i>';
            }
